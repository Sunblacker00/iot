...
#### Defining Flask App / กำหนดFlask App
app = Flask(__name__)
...
#### This function will run when we click on Take Attendance Button / ฟังก์ชั่นนี้จะทำงานเมื่อเราคลิกที่ปุ่ม Take Attendance "เข้าสู่ระบบเช็คชื่อ"
@app.route('/start',methods=['GET'])
def start():
    if 'face_recognition_model.pkl' not in os.listdir('static'):
        return render_template('Attendance.html',totalreg=totalreg(),datetoday2=datetoday2,mess='There is no trained model in the static folder. Please add a new face to continue.') 
...
#### This function will run when we add a new user / ฟังก์ชันนี้จะทำงานเมื่อเราเพิ่มผู้ใช้ใหม่ "จดจำสมาชิก" 
...
#### Our main function which runs the Flask App / หน้าที่หลักของเราซึ่งรันแอพ Flask
